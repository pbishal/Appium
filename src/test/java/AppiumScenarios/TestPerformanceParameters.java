...
public class TestPerformanceParameters {
	...
	public void deviceTest() {
		...
		List<List<Object>> batterydata = ((AndroidDriver) driver).getPerformanceData("io.appium.android.apis",
				"batteryinfo", 5);
		System.out.println(batterydata);

		System.out.println("Performance parameters for Memory");
		List<List<Object>> memorydata = ((AndroidDriver) driver).getPerformanceData("io.appium.android.apis",
				"memoryinfo", 5);
		System.out.println(memorydata);

		System.out.println("Performance parameters for Network");
		List<List<Object>> networkdata = ((AndroidDriver) driver).getPerformanceData("io.appium.android.apis",
				"networkinfo", 5);
